      ...
      <div class="table-box">
        ...
        ';
            ...
            while ($row = mysqli_fetch_assoc($result)) {              
                printf ("<tr class='table-tr'><td class='table-td'>%s</td> <td class='table-td'>%s</td> <td class='table-td'>%s</td> <td class='table-td'>%s</td></tr>", $row["id"], $row["fio"], $row["cartridge"], $row["cabinet"], $row["delivery"]);
            }
            echo "</table>";
            /* удаление выборки */
