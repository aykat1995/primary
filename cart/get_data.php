    ...
    <div class="container">
      <div class="table-box">
        ...
        ';
            ...
            printf ("<tr class='table-tr'><th class='table-th'>Номер</th><th class='table-th'>ФИО</th><th class='table-th'>Тип картриджа</th><th class='table-th'>Кабинет</th><th class='table-th'>Дата</th></tr>");
            while ($row = mysqli_fetch_assoc($result)) {              
                printf ("<tr class='table-tr'><td class='table-td'>%s</td> <td class='table-td'>%s</td> <td class='table-td'>%s</td> <td class='table-td'>%s</td> <td class='table-td'>%s</td></tr>", $row["id"], $row["fio"], $row["cartridge"], $row["cabinet"], $row["todayDate"]);
            }
            echo "</table>";
            /* удаление выборки */
